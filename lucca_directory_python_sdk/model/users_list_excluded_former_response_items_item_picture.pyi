...
class UsersListExcludedFormerResponseItemsItemPicture(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "href", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "href", ], str]):
    ...
    ) -> 'UsersListExcludedFormerResponseItemsItemPicture':
